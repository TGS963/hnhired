...
export default function JobCard({
  ...
  return (
    <Link
      href={`/job/${id}`}
      onClick={markSeen}
      className={`bg-surface border border-border-c rounded-xl p-4 flex flex-col gap-2.5 cursor-pointer transition-all duration-150 hover:border-border-strong${seenClass(seen)}`}
    >
